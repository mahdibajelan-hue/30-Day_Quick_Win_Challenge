...

{
  ...
  "executive_decisions_needed": [
    { "decision": "تصمیم مورد نیاز از مدیریت ارشد", "why_now": "چرا این تصمیم همین الان لازم است", "impact": "اثر مورد انتظار این تصمیم بر پروژه", "contractor_commitment": "تعهد متقابلی که در ازای این تصمیم/مصوبه از پیمانکار یا مجری طرح باید گرفته شود (مثلاً جبران تأخیر ظرف مدت مشخص، تسریع یک جبهه کاری، تحویل مستندات) — اگر واقعاً تعهد متقابل معناداری متصور نیست، رشته خالی بگذار" }
  ],
